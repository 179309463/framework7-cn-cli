...
async function checkUpdate() {
  ...
  //   axios
  //     .get('https://registry.npmjs.org/framework7-cn-cli/latest')
  //     .then((res) => {
  ...
  //   log.text(`\n${logSymbols.warning} Please update framework7-cn-cli to latest version before continue.`, true);
  //   log.text(`${logSymbols.warning} To update framework7-cn-cli, run in terminal:`, true);
  //   log.text('\nnpm install framework7-cn-cli -g\n', true);
  //   process.exit(1);
  // } else {
  //   spinner.done('All good, you have latest framework7-cn-cli version.');
  // }
}
